    ...
    <div class="flex justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block aling-bottom bg-white rounded-lg text-left overflow.hidden shadow-x1 transform transition-all  sm-my-8 sm:alingn-middle sm:max-w-lg sm:w.full" role="dialog" aria-modal="true" aria-labelledby="modal-eadline">
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <h2 class="mb-3">EDITAR ANIMES</h2>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    <label for="temporadas" class="block text-gray-700 text-sm font-bold mb-2">Temporadas:</label>
                    <input type="text" class="shadow apparence-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-one focus:shadow-outline" id="temporadas" wire:model="Temporadas">
                </div>
